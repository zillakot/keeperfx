...
pub struct Counters {
    ...
    pub arena_minimap_prefix_bytes: u64,
    pub arena_minimap_dictionary_bytes: u64,
    pub arena_minimap_cells_bytes: u64,
    pub arena_minimap_styles_bytes: u64,
    pub minimap_dictionary_hits: u64,
    pub minimap_dictionary_misses: u64,
    pub minimap_cells_hits: u64,
    pub minimap_cells_misses: u64,
    pub minimap_styles_hits: u64,
    pub minimap_styles_misses: u64,
