...
int main()
{
    ...
    static_assert(offsetof(KfxWgpuDrawCounters, replay_submit_wait_ns) == 198 * sizeof(uint64_t));
    ...
    static_assert(offsetof(KfxWgpuDrawCounters, replay_bind_groups) == 199 * sizeof(uint64_t));
    ...
    static_assert(offsetof(KfxWgpuDrawCounters, replay_buffers) == 200 * sizeof(uint64_t));
    ...
    static_assert(offsetof(KfxWgpuDrawCounters, replay_passes) == 201 * sizeof(uint64_t));
    ...
    static_assert(offsetof(KfxWgpuDrawCounters, replay_staged_bytes) == 202 * sizeof(uint64_t));
