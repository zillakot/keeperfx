...
option(KFX_SOUND_REGISTRY_TESTS "Build sound registry regression tests" OFF)
if(KFX_SOUND_REGISTRY_TESTS)
    enable_testing()
    add_executable(sound_manager_registry_test
        "${CMAKE_SOURCE_DIR}/tests/sound_manager_registry.cpp"
        "${CMAKE_SOURCE_DIR}/src/sound_manager.cpp")
    target_include_directories(sound_manager_registry_test PRIVATE "${CMAKE_SOURCE_DIR}/src")
    target_compile_definitions(sound_manager_registry_test PRIVATE BFDEBUG_LEVEL=0)
    kfx_link_dependencies(sound_manager_registry_test)
    if(APPLE)
        target_link_options(sound_manager_registry_test PRIVATE "-Wl,-dead_strip")
    else()
        target_compile_options(sound_manager_registry_test PRIVATE -ffunction-sections -fdata-sections)
        target_link_options(sound_manager_registry_test PRIVATE "-Wl,--gc-sections")
    endif()
    add_test(NAME sound_manager_registry COMMAND sound_manager_registry_test)
endif()
